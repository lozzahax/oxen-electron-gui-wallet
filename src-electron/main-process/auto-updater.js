...
async function showUpdateDialog(mainWindow) {
  ...
  const options = {
    ...
    title: "Lozzax Electron Wallet update available",
    message: "There is a new version of Lozzax Electron Wallet available.",
...
async function showCannotUpdateDialog(mainWindow) {
  const options = {
    ...
    title: "Cannot update",
    message:
      "Lozzax Electron Wallet failed to update but there is a new version available. Please go to https://lozzax.xyz/ and install the new version manually."
  };
