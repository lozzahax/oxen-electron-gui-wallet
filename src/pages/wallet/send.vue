      ...
      <div class="q-pa-md">
        <div class="row gutter-md">
          ...
          <div class="col-6 priority">
            <LozzaxField :label="$t('fieldLabels.priority')">
              <q-select
        ...
        <!-- Notes -->
        <div class="col q-mt-sm">
          <LozzaxField :label="$t('fieldLabels.notes')" optional>
            <q-input
              v-model="newTx.note"
        ...
        <div v-if="newTx.address_book.save">
          <LozzaxField :label="$t('fieldLabels.name')" optional>
            <q-input
          ...
          <LozzaxField class="q-mt-sm" :label="$t('fieldLabels.notes')" optional>
            <q-input
