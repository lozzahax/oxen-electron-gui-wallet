export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "Не найден файл lozzaxd, используется удаленная нода"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lozzaxBalance: "Баланс",
    lozzaxUnlockedBalance: "Разблокированый баланс",
    lozzaxUnlockedShort: "Разблокировано",
