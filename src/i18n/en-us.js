export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "lozzaxd not found, using remote node"
    }
  },
  placeholders: {
    ...
    onsName: "The name to purchase via Lozzax Name Service",
    ...
    sessionId: "The Session ID to link to Lozzax Name Service",
  ...
  strings: {
    ...
    lozzaxUnlockedBalance: "Unlocked balance",
    lozzaxUnlockedShort: "Unlocked",
    me: "Me",
    ...
    serviceNodeContributionDescription:
      "Staking contributes to the safety of the Lozzax network. For your contribution, you earn LOZZAX. Once staked, you will have to wait either 15 or 30 days to have your LOZZAX unlocked, depending on if a stake was unlocked by a contributor or the node was deregistered. To learn more about staking, please visit the documentation on the",
