export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Lozzax",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "lozzaxd no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lozzaxBalance: "Saldo",
    lozzaxUnlockedBalance: "Saldo libre",
    lozzaxUnlockedShort: "Libre",
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (lozzaxd) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
